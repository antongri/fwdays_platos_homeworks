...
// +kubebuilder:rbac:groups=apps.my.domain,resources=demoes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apps.my.domain,resources=demoes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=apps.my.domain,resources=demoes/finalizers,verbs=update
...
func (r *DemoReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// Update status
	demo.Status.AvailableReplicas = demo.Spec.Replicas + 5
