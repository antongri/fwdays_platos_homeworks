...
<body>
    <div class="container">
        ...
        <p>Redis is available at: redis:6379 (internal network) My name is ${name} and is done by Bohdan</p>
...
const webApp = new WebAppStack(stackName, stackName === "prod" ? 8083 : 8084);

// Export useful information
export const nginxUrl = pulumi.interpolate`http://localhost:${stackName === "prod" ? 8083 : 8084}`;
export const redisPort = stackName === "prod" ? 7083 : 7084;
